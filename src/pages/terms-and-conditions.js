        ...
        <section className="prose mx-auto">
            ...
            <article>
                <p>
                    ...
                    for the use of Premium Cases Design's Website.
                </p>
                <span>Premium Cases Design</span> is located at:
                <br />
                <address>
                    Budapest <br />- Pest , Hungary
                    <br />
                </address>
                <p>
                    By accessing this website we assume you accept these terms
                    and conditions in full. Do not continue to use Premium Cases
                    | Design's website if you do not accept all of the terms and
                ...
                <p>
                    ...
                    subject to, prevailing law of Hungary. Any use of the above
                ...
                <h3>Cookies</h3>
                <p>
                    We employ the use of cookies. By using Premium Cases |
                    Design's website you consent to the use of cookies in
                    accordance with Premium Cases Design's privacy policy.
                </p>
                <p>
                ...
                <p>You must not:</p>
                <ol>
                    <li>Republish material from https://premiumcases.design</li>
                    <li>
                        Sell, rent or sub-license material from
                        https://premiumcases.design
                    </li>
                    <li>
                ...
                <ol>
                    <li>
                        ...
                        <ol>
                            ...
                            <li>
                                Online directory distributors when they list us
                                in the directory may link to our Web site in the
                                same manner as they hyperlink to the Web sites
                    ...
                    <li>
                        ...
                        <ol>
                            <li>
                                ...
                                Commerce, American Automobile Association, AARP
                                and Consumers Union;
                            </li>
                ...
                <p>
                    ...
                    the hyperlink outweighs the absence of Premium Cases |
                    Design; and (d) where the link is in the context of general
                    resource information or is otherwise consistent with
